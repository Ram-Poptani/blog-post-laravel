...
<div class="row mt25 animated" data-animation="fadeInUp" data-animation-delay="100">
    ...
    <div class="col-md-6">
        <a href="#" class="button button-sm button-pasific pull-left hover-skew-backward" onclick="(e) => {e.preventDefault();}">
            Old Entries
        </a>
    </div>
    @else
    ...
    @else
    <div class="col-md-6">
        <a href="#" class="button button-sm button-pasific pull-right hover-skew-forward">
            New Entries
        </a>
    </div>
    @endif
